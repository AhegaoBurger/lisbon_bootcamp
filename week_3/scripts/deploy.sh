...
# Replace the frontend .env file update section with this:
CONSTANTS_FILE="arturcoin-frontend/src/constants/index.ts"
echo "Updating frontend constants file: $CONSTANTS_FILE"
cat > "$CONSTANTS_FILE" << EOF
// This file is auto-generated by deploy.sh
export const packageId = "$PACKAGE_ID";
export const coinManager = "$COIN_MANAGER_ID";
export const network = "$JSON_NETWORK_NAME";
export const deploymentDate = "$(date -u +"%Y-%m-%dT%H:%M:%SZ")";
EOF

# Update the final output section to show new file
